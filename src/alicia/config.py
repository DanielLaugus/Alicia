...
def load_settings(env_file: str | Path | None = ".env") -> Settings:
    ...
    return Settings(
        ...
        orderbook_max_spread_bps=_as_float("ORDERBOOK_MAX_SPREAD_BPS", 2.0),
        orderbook_levels=_as_int("ORDERBOOK_LEVELS", 10),
        orderbook_imbalance_min=_as_float("ORDERBOOK_IMBALANCE_MIN", 0.20),
        orderbook_min_bid_depth=_as_float("ORDERBOOK_MIN_BID_DEPTH", 2.0),
